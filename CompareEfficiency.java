...
public class CompareEfficiency {
    public static void main(String[] args) throws InterruptedException {
      executeCompareData(0);
      executeCompareData(10);
      executeCompareData(100);
      executeCompareData(1000);
      executeCompareData(10000);
      executeCompareData(100000);
    }

  private static void executeCompareData(int numOrders) {
